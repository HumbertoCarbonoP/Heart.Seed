...
async function scrapeNews(url) {
    ...
    const [el] = await page.$x('/html/body/div[7]/div/div[10]/div/div[2]/div[2]/div/div/div/div/div[5]/div/a/div/div[1]/div/div/img');
    const src = await el.getProperty("src");
    const newsImg = await src.jsonValue();

    const [el2] = await page.$x('//*[@id="rso"]/div/div/div[5]/div/a/div/div[2]/div[2]');
